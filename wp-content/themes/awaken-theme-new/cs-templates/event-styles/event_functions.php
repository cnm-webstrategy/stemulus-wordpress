...
if ( ! function_exists( 'cs_event_listing' ) ) {
	function cs_event_listing($atts, $content = ""){
		...
		while ( $user_query->have_posts() ) { $user_query->the_post();
			...
			$user_ids = isset($cs_event_meta->dynamic_event_members) ? $cs_event_meta->dynamic_event_members:'';
...
if ( ! function_exists( 'cs_location_fields' ) ) {
	function cs_location_fields(){
		...
		//var_dump($dynamic_post_location_latitude);
			?>
		...
		<div class="option-sec" style="margin-bottom:0;">
		  <div class="opt-conts">
			<ul class="form-elements">
              <li class="to-label">
                <label><?php _e('Location Map','Awaken');?></label>
              </li>
            ...
            <ul class="form-elements">
			  <li class="to-label">
				<label><?php _e('Address','Awaken');?></label>
			  </li>
			  <li class="to-field">
            ...
            <ul class="form-elements">
			  <li class="to-label">
				<label><?php _e('City / Town','Awaken');?></label>
			  </li>
			  <li class="to-field">
			...
			<ul class="form-elements">
			  <li class="to-label">
				<label><?php _e('Post Code','Awaken');?></label>
			  </li>
			  <li class="to-field">
			...
			<ul class="form-elements">
			  <li class="to-label">
				<label><?php _e('Region','Awaken');?></label>
			  </li>
			  <li class="to-field">
			...
			<ul class="form-elements">
			  <li class="to-label">
				<label><?php _e('Country','Awaken');?></label>
			  </li>
			  <li class="to-field">
			...
			<ul class="form-elements">
			  ...
			  <li class="to-field">
				<input type="button" class="gllpSearchButton" value="<?php _e('Search This Location on Map','Awaken');?>" onClick="gll_search_map()">
			  </li>
			</ul>
...
<link type="text/css" rel="stylesheet"  href="<?php echo get_template_directory_uri();?>/include/assets/css/common.css" />
	...
	<ul class="form-elements">
	  <li class="to-label">
		<label><?php _e('Event Date','Awaken');?></label>
	  </li>
	...
	<ul class="form-elements event-day bcevent_title">
	  <li class="to-label">
		<label><?php _e('Event Time','Awaken');?></label>
	  </li>
	  <li class="to-field">
		<div id="event_time" <?php /*?><?php if($dynamic_post_event_all_day=='on')echo 'style="display:none"'?><?php */?>>
		  <div class="input-sec">
			...
			<label class="first-label"><?php _e('Start time','Awaken');?></label>
		  </div>
		  ...
		  <div class="input-sec">
			...
			<label class="sec-label"><?php _e('End time','Awaken');?></label>
		  </div>
		  <div class="input-sec">
			...
			<label><?php _e('AllDay','Awaken');?></label>
		  </div>
		</div>
	  </li>
	</ul>
	...
	<ul class="form-elements">
	  <li class="to-label">
		<label><?php _e('Repeat','Awaken');?></label>
	  </li>
	  <li class="to-field">
		<div class="input-sec">
		  <div class="select-style">
			<select name="dynamic_post_event_repeat" class="dropdown" onchange="toggle_with_value('num_repeat', this.value)">
			  <option value="0"><?php _e('Never Repeat','Awaken');?></option>
			  <option value="+1 day"><?php _e('Every Day','Awaken');?></option>
			  <option value="+1 week"><?php _e('Every Week','Awaken');?></option>
			  <option value="+1 month"><?php _e('Every Month','Awaken');?></option>
			</select>
		  </div>
		</div>
	  </li>
	...
	<ul class="form-elements" id="num_repeat" style="display:none">
	  <li class="to-label">
		<label><?php _e('Repeat how many time','Awaken');?></label>
	  </li>
	  <li class="to-field">
		<div class="input-sec">
		  <div class="select-style">
	...
	<ul class="form-elements">
	  <li class="to-label">
		<label><?php _e('Ticket Option','Awaken');?></label>
	  </li>
	  <li class="to-field">
		<div class="input-sec">
    ...
    <ul class="form-elements">
	  <li class="to-label">
		<label><?php _e('Contact No','Awaken');?></label>
	  </li>
	  <li class="to-field">
		<div class="input-sec">
