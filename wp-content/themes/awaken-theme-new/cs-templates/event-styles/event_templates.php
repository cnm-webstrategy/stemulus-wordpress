                        ...
                        <div class="cstime">
                            ...
                            <span>
                            	<?php 
									  ...
									  if( isset( $cs_event_meta->dynamic_post_event_start_time ) && $cs_event_meta->dynamic_post_event_start_time <> ''){
										//echo get_option('time_format')."yes i am here";
                            ...
                            <span>
                            	<?php 
									  ...
									  if( isset( $cs_event_meta->dynamic_post_event_start_time ) && $cs_event_meta->dynamic_post_event_start_time <> ''){
										$newdate1 = date_i18n('M j, Y @ G:i', strtotime($cs_event_meta->dynamic_post_event_start_time)).' ';
										$newDt = explode("@",$newdate1);
										echo $newDt[1];
									  }
									  if(isset($cs_event_meta->dynamic_post_event_end_time) && $cs_event_meta->dynamic_post_event_end_time <> ''){
										_e('To', 'Awaken');
										$newdate2 = date_i18n('M j, Y @ G:i', strtotime($cs_event_meta->dynamic_post_event_end_time)).' ';
										$newDt1 = explode("@",$newdate2);
										echo $newDt1[1];
									  }
								 ?>
                            </span>
				...
				<div class="ev-inn">
					<div class="cstime">
						...
						<?php if(isset($time_formate) and $time_formate <> '' and $time_formate == "12 hour"){ 
										  ...
										  if( isset( $cs_event_meta->dynamic_post_event_start_time ) && $cs_event_meta->dynamic_post_event_start_time <> ''){
                                           $newdate =  date_i18n( 'M j, Y @ G:i', strtotime($cs_event_meta->dynamic_post_event_start_time)).' ';
										   $newdate5 = explode("@",$newdate);
										   echo $newdate5[1];
                                          }
                                          if(isset($cs_event_meta->dynamic_post_event_end_time) && $cs_event_meta->dynamic_post_event_end_time <> ''){
                                            _e('To', 'Awaken');
                                            $newDate = ' ' . date_i18n( 'M j, Y @ G:i', strtotime($cs_event_meta->dynamic_post_event_end_time) );
											$newdate6 = explode("@",$newDate);
											echo $newdate6[1];
                                          }
