		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					'This theme requires the following plugin: %1$',
					'This theme requires the following plugins: %1$',
					'tgmpa'
				),
				...
				'complete'                        => __( 'All plugins installed and activated successfully. %1$', 'Awaken' ),
		...
		protected function activate_single_plugin( $file_path, $slug, $automatic = false ) {
			...
			if ( ! is_plugin_active( $file_path ) ) {
				...
				echo '<div id="message" class="error"><p>',
					sprintf(
						esc_html__( 'No action taken. Plugin %1$ was already active.', 'Awaken' ),
