	...
	<ul class="form-elements">
      ...
      <li class="to-field">
			<input id="sermon_notes_link" name="sermon_notes_link" value="<?php echo esc_attr($sermon_notes_link); ?>" type="text" class="small" />
             <input id="sermon_notes_link" name="sermon_notes_link" type="button" class="uploadMedia left" value="<?php _e('Browse','Awaken');?>"/>
      </li>
    </ul>
	...
	<ul class="form-elements">
      ...
      <li class="to-field">
			<input id="sermon_audio_download_link" name="sermon_audio_download_link" value="<?php echo esc_attr($sermon_audio_download_link); ?>" type="text" class="small" />
             <input id="sermon_audio_download_link" name="sermon_audio_download_link" type="button" class="uploadMedia left" value="<?php _e('Browse','Awaken');?>"/>
      </li>
    </ul>
	  ...
	  <div id="add_sermon_listings" style="display: none;">
        ...
        <ul class="form-elements">
		  ...
		  <li class="to-field">
             ...
             <input id="sermon_file_url" name="sermon_file_url" type="button" class="uploadMedia left" value="<?php _e('Browse','Awaken');?>"/>
		  </li>
		</ul>
		...
		<ul class="form-elements noborder">
		  ...
		  <li class="to-field">
			<input type="button" value="<?php _e('Add Sermon','Awaken');?>" onClick="add_sermon_to_list('<?php echo esc_js(admin_url('admin-ajax.php'))?>', '<?php echo esc_js(get_template_directory_uri())?>')" />
		  </li>
		</ul>
	  </div>
	  	<script>
					...
					<ul class="form-elements">
						...
						<li class="to-field">
                        	<input id="sermon_file_url<?php echo esc_attr($counter_sermons);?>" name="sermon_file_url_array[]" value="<?php echo esc_url($sermon_file_url)?>" type="text" class="small" />
             				<input id="sermon_file_url<?php echo esc_attr($counter_sermons);?>" name="sermon_file_url_array[]" type="button" class="uploadMedia left" value="<?php _e('Browse','Awaken');?>"/>
					</ul>
