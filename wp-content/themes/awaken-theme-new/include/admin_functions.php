        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="cs_size" name="var_pb_member_view[]">
              <option value="default" <?php if($var_pb_member_view == 'default'){echo 'selected="selected"';}?>><?php _e('Number View','Awaken');?></option>
              <option value="grid" <?php if($var_pb_member_view == 'grid'){echo 'selected="selected"';}?>><?php _e('Grid View','Awaken');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
