...
$cs_theme_options['cs_contribute_now']=isset($cs_theme_options['cs_contribute_now']) ? $cs_theme_options['cs_contribute_now']:'';
$cs_theme_options['cs_contribute_now_link']=isset($cs_theme_options['cs_contribute_now_link']) ? $cs_theme_options['cs_contribute_now_link']:'';
...
$cs_theme_options['icon']=isset($cs_theme_options['icon']) ? $cs_theme_options['icon']:'';
...
$cs_theme_options['cs_dashboard']=isset($cs_theme_options['cs_dashboard']) ? $cs_theme_options['cs_dashboard']:'';
$cs_theme_options['cs_cause_campaigns_allow']=isset($cs_theme_options['cs_cause_campaigns_allow']) ? $cs_theme_options['cs_cause_campaigns_allow']:'';
$cs_theme_options['cs_campaigns_visibility']=isset($cs_theme_options['cs_campaigns_visibility']) ? $cs_theme_options['cs_campaigns_visibility']:'';
$cs_theme_options['cs_compaigns_text']=isset($cs_theme_options['cs_compaigns_text']) ? $cs_theme_options['cs_compaigns_text']:'';
$cs_theme_options['cs_add_compaigns_text']=isset($cs_theme_options['cs_add_compaigns_text']) ? $cs_theme_options['cs_add_compaigns_text']:'';
$cs_theme_options['cs_compaigns_terms_text']=isset($cs_theme_options['cs_compaigns_terms_text']) ? $cs_theme_options['cs_compaigns_terms_text']:'';
$cs_theme_options['cs_paypal_sandbox']=isset($cs_theme_options['cs_paypal_sandbox']) ? $cs_theme_options['cs_paypal_sandbox']:'';
$cs_theme_options['cs_donation_user_register']=isset($cs_theme_options['cs_donation_user_register']) ? $cs_theme_options['cs_donation_user_register']:'';
$cs_theme_options['paypal_email']=isset($cs_theme_options['paypal_email']) ? $cs_theme_options['paypal_email']:'';
$cs_theme_options['paypal_ipn_url']=isset($cs_theme_options['paypal_ipn_url']) ? $cs_theme_options['paypal_ipn_url']:'';
$cs_theme_options['paypal_payments']=isset($cs_theme_options['paypal_payments']) ? $cs_theme_options['paypal_payments']:'';
$cs_theme_options['paypal_currency']=isset($cs_theme_options['paypal_currency']) ? $cs_theme_options['paypal_currency']:'';
$cs_theme_options['paypal_currency_sign']=isset($cs_theme_options['paypal_currency_sign']) ? $cs_theme_options['paypal_currency_sign']:'';
