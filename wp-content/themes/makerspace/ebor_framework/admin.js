...
function show_boxes(){
	...
	if ( $('select#page_template :selected').val() == 'page-portfolio-basic.php' || $('select#page_template :selected').val() == 'page-portfolio-drag.php' || $('select#page_template :selected').val() == 'page-portfolio-grid-black.php' || $('select#page_template :selected').val() == 'page-portfolio-grid-block.php' || $('select#page_template :selected').val() == 'page-portfolio-grid-white.php' || $('select#page_template :selected').val() == 'page-portfolio-stripe.php' ) {
