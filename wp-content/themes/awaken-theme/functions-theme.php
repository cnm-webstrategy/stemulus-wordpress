...
if (!function_exists('cs_bg_image')) {
    ...
    function cs_bg_image() {
        ...
        if (isset($cs_bg_image) && $cs_bg_image <> "") {
                                        ...
                                        <div class="under-wrapp">
                                            ...
                                            <div class="cons-text-wrapp">
                                                ...
                                                if ($cs_uc_options['cs_maintenance_text']) {
                                                    ...
                                                    <p><?php _e('We\'re currently under maintenance, if all goes as planned we\'ll be back in', 'Awaken'); ?></p>
                                                    <?php
                                                }
                                                ?>
...
if (!function_exists('cs_footer_twitter')) {
    ...
    function cs_footer_twitter() {
        ...
        $html .= "<div class='widget_slider'>"
                . "<div class='flexslider flexslider" . $rand_id . "'>"
                . "<ul class='slides'>";
