...
if ( ! function_exists('cs_header_strip') ) {
	...
	function cs_header_strip($container = 'on') {
		...
		if ( isset($cs_theme_options['cs_woocommerce_switch']) ) {
			$cs_woocommerce_switch = $cs_theme_options['cs_woocommerce_switch'];
		} else {
			$cs_woocommerce_switch = '';
		}
	...
	function cs_search($search_class = 'cs-searchv2') {
		...
		<div class="search-top <?php echo cs_allow_special_char($search_class); ?>">
			<form id="searchform" method="get" action="<?php echo home_url() ?>"  role="search">
				<input type="text" name="s" id="searchinput" value="<?php _e('Enter your search', 'Awaken'); ?>" onblur="if (this.value == '') {
		                            this.value = '<?php _e('Enter your search', 'Awaken'); ?>';
		                        }" onfocus="if (this.value == '<?php _e('Enter your search', 'Awaken'); ?>') {
		                                    this.value = '';
		                                }"  >
...
if ( ! function_exists('cs_contribute_now') ) {
	...
	if ( ! function_exists('cs_header_banner_addsense') ) {

		function cs_header_banner_addsense() {
			global $cs_theme_options;
			$cs_header_banner_addsense_content = (isset($cs_theme_options['cs_header_banner_addsense'])) ? $cs_theme_options['cs_header_banner_addsense'] : '';
			if ( isset($cs_theme_options['cs_header_banner_addsense']) and $cs_theme_options['cs_contribute_now'] <> '' and $cs_header_banner_addsense_content <> '' ) {
				var_dump($cs_header_banner_addsense_content);
			}
		}
...
if ( ! function_exists('cs_get_headers') ) {
	...
	function cs_get_headers() {
		...
		if ( isset($cs_header_options) and $cs_header_options == 'header_1' ) {
			...
			<!-- Header End --> 
			<!-- Header 1 End -->
		<?php } elseif ( isset($cs_header_options) and $cs_header_options == 'header_2' ) {
			?>
			<header id="main-header" class="<?php echo cs_allow_special_char($cs_header_options); ?>"> 
				<!-- Top Strip -->
				<?php cs_header_strip(); ?>
			...
			<!-- Header 2 End -->
		<?php } elseif ( isset($cs_header_options) and $cs_header_options == 'header_3' ) {
			?>
			<!-- Header 3 Start -->
			<header id="main-header" class="<?php echo cs_allow_special_char($cs_header_options); ?>">
				<!-- Top Strip -->
			...
			<!-- Header 3 End -->
		<?php } elseif ( isset($cs_header_options) and $cs_header_options == 'header_4' ) {
			?>
			<header id="main-header" class="<?php echo cs_allow_special_char($cs_header_options); ?>"> 
				<div class="container">
					<!-- Top Strip -->
...
if ( ! function_exists('cs_breadcrumb_header') ) {
	...
	function cs_breadcrumb_header($post_ID = '') {
		...
		if ( isset($header_banner_image) && $header_banner_image != '' ) {
			...
			$image_exsist = wp_remote_fopen($header_banner_image, 'r');
