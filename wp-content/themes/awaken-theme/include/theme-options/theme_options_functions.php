...
if (!function_exists('theme_option_save')) {
    ...
    function theme_option_save() {
        ...
        echo __("All Settings Saved", 'Awaken');
...
if (!function_exists('cs_options_backup_generate')) {
    ...
    function cs_options_backup_generate() {
        ...
        if (!$wp_filesystem->put_contents($cs_filename, $cs_option_fields, FS_CHMOD_FILE)) {
            echo __("Error saving file!", 'Awaken');
        } else {
            echo __("Backup Generated.", 'Awaken');
        }
...
if (!function_exists('cs_backup_file_delete')) {
    ...
    function cs_backup_file_delete() {
        ...
        if (is_file($cs_filename)) {
            unlink($cs_filename);
            printf(__("File '%s' Deleted Successfully", 'Awaken'), $file_name);
        } else {
            echo __("Error Deleting file!", 'Awaken');
        }
    ...
    function cs_backup_file_restore() {
        ...
        if ($file_path == 'yes') {
            ...
            if ($cs_file_body != '') {
                ...
                _e("File Import Successfully", 'Awaken');
            } else {
                _e("Error Restoring file!", 'Awaken');
            }
        ...
        if (is_file($cs_filename)) {
            ...
            printf(__("File '%s' Restore Successfully", 'Awaken'), $file_name);
        } else {
            _e("Error Restoring file!", 'Awaken');
        }
