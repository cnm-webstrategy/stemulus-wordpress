            ...
            <div class="inner">
                ...
                <div class="row">   
                    <form id="frm" method="post">
                        ...
                        <div class="clear"></div>
                        <div class="footer">
                            <input type="button" id="submit_btn" name="submit_btn" class="bottom_btn_save" value="<?php _e('Save All Settings', 'Awaken'); ?>" onclick="javascript:theme_option_save('<?php echo admin_url('admin-ajax.php') ?>', '<?php echo get_template_directory_uri(); ?>');" />
                            <input type="hidden" name="action" value="theme_option_save"  />
                            <input class="bottom_btn_reset" name="reset" type="button" value="<?php _e('Reset All Options', 'Awaken'); ?>"  
...
if (!function_exists('cs_theme_option')) {
    ...
    function cs_theme_option() {
        ...
        $options[] = array(
            ...
            "std" => "full_width",
            "options" => array(
                "boxed" => __("Boxed", 'Awaken'),
                "full_width" => __("Full Width", 'Awaken'),
            ),
            "type" => "layout",
        );
        ...
        $options[] = array(
            ...
            "type" => "horizontal_tab",
            "std" => "",
            "options" => array(__('Background', 'Awaken') => 'background_tab', __('Pattern', 'Awaken') => 'pattern_tab', __('Custom Image', 'Awaken') => 'custom_image_tab')
        );
...
//        );
        ...
        $options[] = array("name" => __("Header Position Settings", 'Awaken'),
            "id" => "tab-header-options",
            "std" => __("Header Position Settings", 'Awaken'),
            "type" => "section",
            "options" => ""
        );
        $options[] = array("name" => __("Select Header Position", 'Awaken'),
            "desc" => __("Make header position fixed as Absolute or move it", "Awaken"),
        ...
        $options[] = array("name" => __("Header Top Strip", 'Awaken'),
            "id" => "tab-header-options",
            "std" => __("Header Top Strip", 'Awaken'),
            "type" => "section",
            "options" => ""
        );
        ...
        $options[] = array("name" => __("Short Text", 'Awaken'),
            ...
            "type" => "textarea");
        $options[] = array("name" => __("Header add sense", 'Awaken'),
            "desc" => "",
            "hint_text" => __("Embed Image/Google add sense Code", 'Awaken'),
        ...
        $options[] = array("name" => __("post layout", 'Awaken'),
            ...
            "std" => __("Single Post Layout", 'Awaken'),
            "type" => "section",
            "options" => ""
        );
        ...
        $options[] = array("name" => __("Maintenance Text", 'Awaken'),
            ...
            "std" => __("Sorry, We are down for maintenance We're currently under maintenance, if all goes as planned we'll be back in", 'Awaken'),
            "type" => "textarea"
        );
        ...
        $options[] = array("name" => __("Show Twitter", 'Awaken'),
            ...
            "std" => "off",
            "type" => "checkbox");
        $options[] = array("name" => __("Cache Time Limit", 'Awaken'),
            "desc" => "",
        ...
        $options[] = array("name" => __("Number of tweet", 'Awaken'),
            "desc" => "",
        ...
        $options[] = array("name" => __("Date Time Formate", 'Awaken'),
            "desc" => "",
            "hint_text" => __("Select date time formate for every tweet.", 'Awaken'),
            "id" => "cs_twitter_datetime_formate",
            "std" => "",
            "type" => "select_values",
            "options" => array(
                'default' => __('Displays November 06 2012', 'Awaken'),
                'eng_suff' => __('Displays 6th November', 'Awaken'),
                'ddmm' => __('Displays 06 Nov', 'Awaken'),
                'ddmmyy' => __('Displays 06 Nov 2012', 'Awaken'),
                'full_date' => __('Displays Tues 06 Nov 2012', 'Awaken'),
                'time_since' => __('Displays in hours, minutes etc', 'Awaken'),
            )
        );
        $options[] = array(
            "name" => __("Consumer Key", 'Awaken'),
            "desc" => "",
            "hint_text" => "",
            "id" => "cs_consumer_key",
            "std" => "",
        ...
        //end google api
        //start mailChimp api
        $options[] = array("name" => "Mail Chimp",
            "id" => "mailchimp",
            "std" => __("Mail Chimp", 'Awaken'),
            "type" => "section",
            "options" => ""
        );
        $options[] = array("name" => __("Mail Chimp Key", 'Awaken'),
            "desc" => __("Enter a valid Mail Chimp API key here to get started. Once you've done that, you can use the Mail Chimp Widget from the Widgets menu. You will need to have at least Mail Chimp list set up before the using the widget. You can get your mail chimp activation key", 'Awaken'),
        ...
        $options[] = array("name" => __("Mail Chimp List", 'Awaken'),
            "desc" => "",
            "hint_text" => "",
        ...
        $options[] = array("name" => __("Flickr API Setting", 'Awaken'),
            ...
            "std" => __("Flickr API Setting", 'Awaken'),
            "type" => "section",
            "options" => ""
        );
        ...
        if (class_exists('wp_causes')) {
            ...
            $options[] = array("name" => __("New Campaigns Status", 'Awaken'),
                "desc" => "",
                "hint_text" => __("New Campaigns Visibility. You can set default status of user Campaigns ", 'Awaken'),
            ...
            $options[] = array("name" => __("Paypal Ipn Url", 'Awaken'),
                ...
                "std" => $ipn_url,
                "type" => "text");
            $options[] = array("name" => __("Paypal Payments", 'Awaken'),
                "desc" => "",
                "hint_text" => "",
                "id" => "paypal_payments",
        ...
        $options[] = array("name" => __("Theme Backup Options", 'Awaken'),
            "std" => __("Theme Backup Options", 'Awaken'),
            "id" => "theme-bakups-options",
            "type" => "section"
        );
        $options[] = array("name" => __("Backup", 'Awaken'),
            "desc" => "",
            "hint_text" => __("", 'Awaken'),
        ...
        if (class_exists('cs_widget_data')) {
            ...
            $options[] = array("name" => __("Widgets Backup Options", 'Awaken'),
                "std" => __("Widgets Backup Options", 'Awaken'),
                "id" => "widgets-bakups-options",
                "type" => "section"
            );

            $options[] = array("name" => __("Widgets Backup", 'Awaken'),
                "desc" => "",
                "hint_text" => '',
