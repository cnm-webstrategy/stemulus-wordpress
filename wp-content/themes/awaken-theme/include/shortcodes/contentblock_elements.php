        ...
        <div id="<?php echo cs_allow_special_char($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="infobox" data="<?php echo element_size_data_array_index($infobox_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter) ?> <?php echo cs_allow_special_char($shortcode_element); ?>" id="<?php echo cs_allow_special_char($name . $cs_counter) ?>" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Info box Options', 'Awaken'); ?></h5>
                        ...
                        <div class="wrapptabbox" style="padding:0">
                            <div class="opt-conts">
                                <ul class="form-elements noborder">
                                    <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('infobox_items', 'shortcode-item-<?php echo cs_allow_special_char($cs_counter); ?>', '<?php echo cs_allow_special_char(admin_url('admin-ajax.php')); ?>')"><i class="fa fa-plus-circle"></i><?php _e('Add Item', 'Awaken'); ?></a> </li>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select class="icon_view" id="icon_view" name="icon_view[]" onchange="cs_icon_toggle_view(this.value, '<?php echo esc_attr($rand_counter); ?>', jQuery(this))">
                                    ...
                                    ?> value="bg_style"><?php _e('Background Style', 'Awaken'); ?></option>
                                    <option <?php
                                    if ($icon_view == 'border_style') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="border_style"><?php _e('Border Style', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select class="font_type" id="font_type" name="font_type[]">
                                    ...
                                    ?> value="circle"><?php _e('Circle', 'Awaken'); ?></option>
                                    <option <?php
                                    if ($font_type == 'square') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="square"><?php _e('Square', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select class="font_size" id="font_size" name="font_size[]">
                                    ...
                                    ?> value="small"><?php _e('Small', 'Awaken'); ?></option>
                                    <option <?php
                                    if ($font_size == 'medium') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="medium"><?php _e('Medium', 'Awaken'); ?></option>
                                    <option <?php
                                    if ($font_size == 'large') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="large"><?php _e('Large', 'Awaken'); ?></option>
                                </select>
                        ...
                        <ul class="form-elements" id="selected_icon_view_<?php echo esc_attr($rand_counter) ?>">
                            <li class="to-label">
                                <label><div id="label-icon"><?php echo trim($icon_view) == '' || $icon_view == 'bg_style' ? __('Icon Background Color', 'Awaken') : 'Border Color'; ?></div></label>
...
if (!function_exists('cs_pb_map')) {
    ...
    function cs_pb_map($die = 0) {
        ...
        $defaults = array('cs_map_section_title' => '', 'map_title' => '', 'map_height' => '', 'map_lat' => '51.507351', 'map_lon' => '-0.127758', 'map_zoom' => '', 'map_type' => '', 'map_info' => '', 'map_info_width' => '', 'map_info_height' => '', 'map_marker_icon' => '', 'map_show_marker' => 'true', 'map_controls' => '', 'map_draggable' => '', 'map_scrollwheel' => '', 'map_conactus_content' => '', 'map_border' => '', 'map_color' => '', 'map_border_color' => '', 'cs_map_class' => '', 'cs_map_animation' => '');
        if (isset($output['0']['atts']))
            $atts = $output['0']['atts'];
        else
            $atts = array();
                    ...
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select name="map_type[]" class="dropdown" >
                                    <option value="ROADMAP" <?php if ($map_type == "ROADMAP") echo "selected"; ?> ><?php _e('Roadmap', 'Awaken'); ?></option>
                                    <option value="HYBRID" <?php if ($map_type == "HYBRID") echo "selected"; ?> ><?php _e('Hybrid', 'Awaken'); ?></option>
                                    <option value="SATELLITE" <?php if ($map_type == "SATELLITE") echo "selected"; ?> ><?php _e('Satellite', 'Awaken'); ?></option>
                                    <option value="TERRAIN" <?php if ($map_type == "TERRAIN") echo "selected"; ?> ><?php _e('Terrain', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <label class="browse-icon"><input name="map_marker_icon<?php echo esc_attr($rand_string) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'Awaken'); ?>"/></label>
                                <div class="left-info"><?php _e('Give a link for your marker icon', 'Awaken'); ?></div>
                            </li>
                        </ul>
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                ...
                                <p><?php _e('You can set map control disable/enable', 'Awaken'); ?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select class="dropdown" name="map_border[]">
                                    ...
                                    ?> value="yes"><?php _e('Yes', 'Awaken'); ?></option>
                                    <option <?php
                                    if ($map_border == 'no') {
                                        echo 'selected="selected"';
                                    }
                                    ?> value="no"><?php _e('No', 'Awaken'); ?></option>
                                </select>
    ...
    function cs_pb_offerslider($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter); ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="offerslider" data="<?php echo element_size_data_array_index($offerslider_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter); ?>" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Offer Slider Options', 'Awaken'); ?></h5>
                    ...
                    <div class="cs-wrapp-tab-box">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field select-style">
                                            <select class="column_size" id="column_size" name="column_size[]">
                                                ...
                                                ?>><?php _e('Full width', 'Awaken'); ?></option>
                                                <option value="1/2" <?php
                                                if ($column_size == '1/2') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php _e('One half', 'Awaken'); ?></option>
                                                <option value="2/3" <?php
                                                if ($column_size == '2/3') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php _e('Two third', 'Awaken'); ?></option>
                                                <option value="3/4" <?php
                                                if ($column_size == '3/4') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php _e('Three fourth', 'Awaken'); ?></option>
                                            </select>
                                    ...
                                    ?>">
                                        ...
                                        <ul class="form-elements">
                                            ...
                                            <li class="to-field">
                                                ...
                                                <input name="cs_slider_image<?php echo esc_attr($rand_string) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'Awaken'); ?>"/>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="form-elements">
                                            <li class="to-label">
                                                <label><?php _e('Read More Link', 'Awaken'); ?></label>
                                            </li>
                                            <li class="to-field">
                                        ...
                                        <ul class="form-elements">
                                            ...
                                            <li class="to-field">
                                                ...
                                                <p><?php _e('give the link title here', 'Awaken'); ?></p>
                                            </li>
                                        </ul>
                        ...
                        <div class="wrapptabbox" style="padding:0">
                            <div class="opt-conts">
                                <ul class="form-elements noborder">
                                    <li class="to-field">
                                        <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('offerslider', 'shortcode-item-<?php echo esc_attr($cs_counter); ?>', '<?php echo admin_url('admin-ajax.php'); ?>')"><i class="fa fa-plus-circle"></i><?php _e('Add Offer', 'Awaken'); ?></a>
                                        <div id="loading" class="shortcodeload"></div>
                                    </li>
                                </ul>
                                <?php if (isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode') { ?>
                                    <ul class="form-elements insert-bg">
                                        <li class="to-field">
                                            <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo esc_js(str_replace('cs_pb_', '', $name)); ?>', 'shortcode-item-<?php echo esc_js($cs_counter); ?>', '<?php echo esc_js($filter_element); ?>')" ><?php _e('Insert', 'Awaken'); ?></a>
                                        </li>
                                    </ul>
                                    <div id="results-shortocde"></div>
                                <?php } else { ?>
