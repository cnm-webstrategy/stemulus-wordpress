...
if (!function_exists('cs_map_shortcode')) {
    ...
    function cs_map_shortcode($atts, $content = "") {
        global $header_map;
        $defaults = array('column_size' => '1/1', 'cs_map_section_title' => '', 'map_title' => '', 'map_height' => '', 'map_lat' => '51.507351', 'map_lon' => '-0.127758', 'map_zoom' => '', 'map_type' => '', 'map_info' => '', 'map_info_width' => '200', 'map_info_height' => '200', 'map_marker_icon' => '', 'map_show_marker' => 'true', 'map_controls' => '', 'map_draggable' => '', 'map_scrollwheel' => '', 'map_conactus_content' => '', 'map_border' => '', 'map_border_color' => '', 'map_color' => '', 'cs_map_class' => '', 'cs_map_animation' => '', 'cs_custom_animation_duration' => '1');
        extract(shortcode_atts($defaults, $atts));
        ...
        if ($map_type == 'ROADMAP' && $map_color != '') {
            $html .= "map.setMapTypeId('map_style');";
        }
        $html .= "
