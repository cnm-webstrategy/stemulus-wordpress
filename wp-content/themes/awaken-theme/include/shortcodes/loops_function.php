                                                ...
                                                <li>
                                                    <a href="<?php comments_link(); ?>"><span class="counter">
                                                            ...
                                                            if ($cs_blog_view == 'medium' || $cs_blog_view == 'default') {
                                                                echo comments_number(__('0 Comment', 'Awaken'), __('1 Comment', 'Awaken'), __('% Comments', 'Awaken'));
                                                            } else {
                                                                echo comments_number(__('0', 'Awaken'), __('1', 'Awaken'), __('%', 'Awaken'));
                                                            };
                                                            ?>
