...
if (!function_exists('cs_elements_categories')) {
    ...
    function cs_elements_categories() {
        return array('typography' => __('Typography', 'Awaken'), 'commonelements' => __('Common Elements', 'Awaken'), 'mediaelement' => __('Media Element', 'Awaken'), 'contentblocks' => __('Content Blocks', 'Awaken'), 'loops' => __('Loops', 'Awaken'));
    }
        ...
        <div class="cs-page-composer composer-<?php echo absint($rand) ?>" id="composer-<?php echo absint($rand) ?>" style="display:none">
            <div class="page-elements">
                <div class="cs-heading-area">
                    <h5> <i class="fa fa-plus-circle"></i><?php _e('Add Element', 'Awaken'); ?>  </h5>
                ...
                <div class="cs-filter-content">
                    <p><input type="text" id="quicksearch<?php echo absint($rand) ?>" placeholder="<?php _e('Search', 'Awaken'); ?>" /></p>
        ...
        if (isset($shortcode) && $shortcode <> '') {
                        ...
                        ?>" >
                            <ul class="form-elements">
                                ...
                                <li class="to-field">
                                    ...
                                    <input name="cs_section_bg_image<?php echo absint($rand); ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'Awaken'); ?>"/>
                                </li>
                            </ul>
            ...
            ?>" >
                        ...
                        <div class="meta-body noborder section-background-video-<?php echo esc_attr($randomno); ?>" style=" <?php
                                ...
                                <li class="to-field">
                                   ...
                                   ?>" type="text" />
                                        <label class="cs-browse">
                                            <input name="cs_section_video_url_<?php echo esc_attr($randomno); ?>" type="button" class="uploadMedia left" value="<?php _e('Browse', 'Awaken'); ?>" />
                                        </label>
                                    </div>
                                    <div class="left-info">
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Video Auto Play', 'Awaken'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        <div class="select-style">
                        ...
                        <ul class="form-elements noborder">
                            <li class="to-label">
                                <label><?php _e('Enable Parallax', 'Awaken'); ?></label>
                            </li>
                            <li class="to-field">
                                <div class="input-sec">
                                    <div class="select-style">
                            ...
                            <div class="input-sec">
                                <div class="select-style">
                                    <select name="cs_event_category[]" class="dropdown">
                                        <option value="0"><?php _e('All Categories Posts', 'Awaken'); ?></option>
                            ...
                            <div class="input-sec">
                                <div class="select-style">
                                    <select name="cs_event_time[]" class="dropdown">
                                        <option value="Yes" <?php if ($cs_event_time_db == "Yes") echo "selected"; ?> ><?php _e('Yes', 'Awaken'); ?></option>
                                        <option value="No" <?php if ($cs_event_time_db == "No") echo "selected"; ?> ><?php _e('No', 'Awaken'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="input-sec">
                                <div class="select-style">
                                    <select name="cs_event_pagination[]" class="dropdown" >
                                        <option <?php if ($cs_event_pagination_db == "Show Pagination") echo "selected"; ?> ><?php _e('Show Pagination', 'Awaken'); ?></option>
                                        <option <?php if ($cs_event_pagination_db == "Single Page") echo "selected"; ?> ><?php _e('Single Page', 'Awaken'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="left-info">
                                <p><?php _e('Show navigation only at List View', 'Awaken'); ?></p>
                            </div>
                        </li>
                    </ul>
                    <ul class="form-elements noborder">
                        <li class="to-label">
                            <label><?php _e('No. of Events Per Page', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                            <div class="input-sec">
    ...
    function cs_slider_clone() {
        ...
        <?php $image_path = wp_get_attachment_image_src((int) $cs_node->cs_slider_path, array(get_option("thumbnail_size_w"), get_option("thumbnail_size_h"))); ?>
            ...
            <div class="poped-up" id="edit_<?php echo esc_attr($cs_counter) ?>">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Options', 'Awaken'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Image Title', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Image Description', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Link Target', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                            ...
                            <p><?php _e('Please select image target', 'Awaken'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"></li>
        ...
        <?php $image_path = wp_get_attachment_image_src((int) $cs_node->path, array(get_option("thumbnail_size_w"), get_option("thumbnail_size_h"))); ?>
            ...
            <div class="poped-up" id="edit_<?php echo esc_attr($cs_counter); ?>">
                ...
                <div class="cs-pbwp-content">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Use Image As', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                            <select name="<?php echo esc_attr($clone_field_name); ?>use_image_as[]" class="select_dropdown" onchange="cs_toggle_gal(this.value, <?php echo esc_js($cs_counter) ?>)">
                                <option <?php if ($cs_node->use_image_as == "0") echo "selected"; ?> value="0"><?php _e('LightBox to current thumbnail', 'Awaken'); ?></option>
                                <option <?php if ($cs_node->use_image_as == "1") echo "selected"; ?> value="1"><?php _e('LightBox to Video', 'Awaken'); ?></option>
                                <option <?php if ($cs_node->use_image_as == "2") echo "selected"; ?> value="2"><?php _e('Url', 'Awaken'); ?></option>
                            </select>
                            <p><?php _e('Please select Image link where it will go', 'Awaken'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements" id="video_code<?php echo esc_attr($cs_counter); ?>" <?php if ($cs_node->use_image_as == "0" or $cs_node->use_image_as == "" or $cs_node->use_image_as == "2") echo 'style="display:none"'; ?> >
                        ...
                        <li class="to-field">
                            ...
                            <p><?php _e('Enter Specific Video Url Youtube or Vimeo', 'Awaken'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements" id="<?php echo esc_attr($clone_field_name); ?>link_url<?php echo esc_attr($cs_counter) ?>" <?php if ($cs_node->use_image_as == "0" or $cs_node->use_image_as == "" or $cs_node->use_image_as == "1") echo 'style="display:none"'; ?> >
                        ...
                        <li class="to-field">
                            ...
                            <p><?php _e('Enter specific url', 'Awaken'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"></li>
        ...
        <tr id="edit_track<?php echo esc_attr($counter_social); ?>">
            ...
            <td class="centr" style="width:20%;"><a href="javascript:openpopedup('edit_track_form<?php echo esc_js($counter_social); ?>')" class="actions edit">&nbsp;</a> <a onclick="javascript:return confirm('Are you sure! You want to delete this social icon')" href="javascript:cs_div_remove('edit_track<?php echo esc_attr($counter_social); ?>')" class="actions delete">&nbsp;</a>
                <div class="poped-up" id="edit_track_form<?php echo esc_attr($counter_social); ?>">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('icon/image Url', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                            ...
                            <input id="var_cp_image_url<?php echo esc_attr($counter_social); ?>" name="var_cp_image_url<?php echo esc_attr($counter_track) ?>" type="button" class="uploadfile left" value="<?php _e('Browse', 'Awaken'); ?>"/>
    ...
    function cs_pb_members($die = 0) {
        ...
        <?php cs_element_setting($name, $cs_counter, $members_element_size); ?>
            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter); ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter); ?>" data-shortcode-template="[cs_members {{attributes}}]"  style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Members Options', 'Awaken'); ?></h5>
                    <a href="javascript:removeoverlay('<?php echo esc_js($name . $cs_counter); ?>','<?php echo esc_js($filter_element); ?>')" class="cs-btnclose"><i class="fa fa-times"></i></a> </div>
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Member Views', 'Awaken'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select class="cs_size" name="var_pb_member_view[]">
                                    ...
                                    ?>><?php _e('Number View', 'Awaken'); ?></option>
                                    <option value="grid" <?php
                                    if ($var_pb_member_view == 'grid') {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php _e('Grid View', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Member Roles', 'Awaken'); ?></label>
                            </li>
                            <li class="to-field">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select name="var_pb_members_filterable[]" onchange="cs_members_all_tab(this.value, <?php echo esc_js($cs_counter); ?>)">
                                    <option value="on" <?php if ($var_pb_members_filterable == "on") echo "selected"; ?>><?php _e('On', 'Awaken'); ?></option>
                                    <option value="off" <?php if ($var_pb_members_filterable == "off") echo "selected"; ?>><?php _e('Off', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        ...
                        ?>>
                            <li class="to-label">
                                <label><?php _e('Show All Tab', 'Awaken'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select name="var_pb_members_all_tab[]">
                                    <option value="on" <?php if ($var_pb_members_all_tab == "on") echo "selected"; ?>><?php _e('On', 'Awaken'); ?></option>
                                    <option value="off" <?php if ($var_pb_members_all_tab == "off") echo "selected"; ?>><?php _e('Off', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('Profile Link On/Off', 'Awaken'); ?></label>
                            </li>
                            <li class="to-field select-style">
                                <select name="var_pb_members_profile_inks[]">
                                    <option value="on" <?php if ($var_pb_members_profile_inks == "on") echo "selected"; ?>><?php _e('On', 'Awaken'); ?></option>
                                    <option value="off" <?php if ($var_pb_members_profile_inks == "off") echo "selected"; ?>><?php _e('Off', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            ...
                            <li class="to-field select-style">
                                <select name="var_pb_members_pagination[]" class="dropdown" >
                                    <option <?php if ($var_pb_members_pagination == "Show Pagination") echo "selected"; ?> ><?php _e('Show Pagination', 'Awaken'); ?></option>
                                    <option <?php if ($var_pb_members_pagination == "Single Page") echo "selected"; ?> ><?php _e('Single Page', 'Awaken'); ?></option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label">
                                <label><?php _e('No. of Members Per Page', 'Awaken'); ?></label>
                            </li>
                            <li class="to-field">
    ...
    function cs_add_faq_to_list() {
        ...
        <tr class="parentdelete" id="edit_track<?php echo esc_attr($counter_faq) ?>">
            ...
            <td style="width:0"><div  id="edit_track_form<?php echo esc_attr($counter_faq); ?>" style="display: none;" class="table-form-elem">
                    <div class="cs-heading-area">
                        <h5 style="text-align: left;"><?php _e('FAQ Settings', 'Awaken'); ?></h5>
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('FAQ Description', 'Awaken'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements noborder">
                        ...
                        <li class="to-field">
                            <input type="button" value="Update FAQ" onclick="update_title(<?php echo esc_js($counter_faq); ?>);
                                            removeoverlay('edit_track_form<?php echo esc_js($counter_faq); ?>', 'append')" />
                        </li>
                    </ul>
                </div></td>
        </tr>
...
if (!function_exists('add_social_icon')) {
    ...
    function add_social_icon() {
        ...
        if (isset($icon_awesome) and $icon_awesome <> '') {
            ;
            echo '<i style="color:' . $_POST['social_font_awesome_color'] . '!important;" class="fa ' . $_POST['social_net_awesome'] . ' fa-2x"></i>';
        } else {
            ;
				...
				<li><a onclick="cs_toggle(\'' . str_replace(' ', '-', $_POST['social_net_tooltip']) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
				  <li class="to-label">
					...
					<li class="to-field">
					  ...
					  <label class="browse-icon"><input id="social_net_icon_path' . $counter_icon . '" name="social_net_icon_path' . $i . '" type="button"
					   class="uploadMedia left" value="' . __('Browse', 'Awaken') . '"/></label>
					</li>
					
					<li style="padding: 10px 0px 20px;" class="full">
					   <ul id="cs_infobox_networks' . $counter_icon . '">
						  <li class="to-label">
							<label>' . __('Fontawsome Icon', 'Awaken') . '</label>
						  </li>
					...
					<li class="to-label">
					  <label>' . __('Font Awesome Color', 'Awaken') . '<span></span></label>
					</li>
					<li class="to-field">
					  <div class="input-sec">
    ...
    function cs_fontawsome_icons_box($icon_value = '', $id = '') {
        ...
        <div class="btn-group">
            <div class="input-group <?php echo esc_attr($iconClass); ?> cs-icon-wrap" id="cs-icon-wrap-<?php echo esc_attr($id); ?>">
                <span class="drop_icon_box" style=" <?php
        if (trim($icon_value) != '') {
            echo 'display:block';
        } else {
            echo 'display:none';
