...
function cs_page_options_add() {
    add_meta_box('id_page_options', __('CS Page Option', 'Awaken'), 'cs_page_options', 'page', 'normal', 'high');
}

function cs_page_bulider_add() {
    add_meta_box('id_page_builder', __('CS Page Builder', 'Awaken'), 'cs_page_bulider', 'page', 'normal', 'high');
}
...
function cs_page_bulider($post) {
    ...
    <div class="clear"></div>
    <div class="add-widget"> <span class="addwidget"> <a href="javascript:ajaxSubmit('cs_column_pb','1','column_full')"><i class="fa fa-plus-circle"></i> <?php _e('Add Page Sections', 'Awaken'); ?></a> </span> 
                        ...
                        for ($j = 1; $j <= $a; $j++) {
                            ...
                            // Media Elements Shortcode
                                ...
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    ...
                                    }if (isset($_POST['cs_image_custom_class'][$cs_counter_image]) && $_POST['cs_image_custom_class'][$cs_counter_image] != '') {
                                        $shortcode .= 'cs_image_custom_class="' . htmlspecialchars($_POST['cs_image_custom_class'][$cs_counter_image], ENT_QUOTES) . '" ';
