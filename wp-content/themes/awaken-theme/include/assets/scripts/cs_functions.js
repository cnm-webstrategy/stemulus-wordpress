...
var Data = [{
    ...
    {"Class": "column_25", "title": "25", "element": ["column", "divider", "message_box", "image_frame", "map", "video", "quote", "dropcap", "pricetable", "services", "pastor", 'services', 'counter', "flex_column", "spacer", "heading", "testimonials", "infobox", "promobox", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "counter", "button"]}, ];
...
jQuery(document).ready(function () {
    ...
    jQuery(document).on('click', 'a[href="#tab-location-settings"]', function (e) {
