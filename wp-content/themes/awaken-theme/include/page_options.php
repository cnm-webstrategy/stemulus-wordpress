...
if (!function_exists('cs_general_settings_element')) {
    ...
    function cs_general_settings_element() {
        ...
        <ul class="form-elements">
            <li class="to-label">
                <label><?php _e('Social Sharing', 'Awaken'); ?></label>
            </li>
        ...
        <ul class="form-elements">
            <li class="to-label">
                <label><?php _e('Tags', 'Awaken'); ?></label>
            </li>
            <li class="to-field has_input">
                <label class="pbwp-checkbox">
        ...
        <ul class="form-elements">
            <li class="to-label">
                <label><?php _e('Related Posts', 'Awaken'); ?></label>
            </li>
            <li class="to-field has_input">
                <label class="pbwp-checkbox">
        ...
        <ul class="form-elements">
            <li class="to-label">
                <label><?php _e('Next Previous', 'Awaken'); ?></label>
            </li>
            <li class="to-field has_input">
                <label class="pbwp-checkbox">
        ...
        <ul class="form-elements">
            <li class="to-label">
                <label><?php _e('Show Author', 'Awaken'); ?></label>
            </li>
            <li class="to-field has_input">
                <label class="pbwp-checkbox">
                ...
                <div class="input-sec">
                    ...
                    <div class="select-style">
                        <select name="header_banner_style" class="dropdown" onchange="javascript:cs_slider_element_toggle(this.value)">
                            ...
                            ?> value="default_header" ><?php _e('Default Subheader', 'Awaken'); ?></option>
                            <option <?php
                            if (isset($header_banner_style) and $header_banner_style == "breadcrumb_header") {
                                echo "selected";
                            }
                            ?> value="breadcrumb_header" ><?php _e('Custom Subheader', 'Awaken'); ?></option>
                            <option <?php
                            if (isset($header_banner_style) and $header_banner_style == "custom_slider") {
                                echo "selected";
                            }
                            ?> value="custom_slider" ><?php _e('Revolution Slider', 'Awaken'); ?></option>
                            <option <?php
                            if (isset($header_banner_style) and $header_banner_style == "map") {
                                echo "selected";
                            }
                            ?> value="map" ><?php _e('Map', 'Awaken'); ?></option>
                            <option <?php
                            if (isset($header_banner_style) and $header_banner_style == "no-header") {
                                echo "selected";
                            }
                            ?> value="no-header" ><?php _e('No Subheader', 'Awaken'); ?></option>
                        </select>
                        <script>
                    ...
                    <div class="input-sec">
                        <div class="select-style">
                            <select name="page_title_align">
                                <option value="left" <?php if (isset($cs_xmlObject->page_title_align) and $cs_xmlObject->page_title_align == "left") echo 'selected="selected"'; ?>><?php _e('Left', 'Awaken'); ?></option>
                                <option value="right" <?php if (isset($cs_xmlObject->page_title_align) and $cs_xmlObject->page_title_align == "right") echo 'selected="selected"'; ?>><?php _e('Right', 'Awaken'); ?></option>
                                <option value="center" <?php if (isset($cs_xmlObject->page_title_align) and $cs_xmlObject->page_title_align == "center") echo 'selected="selected"'; ?>><?php _e('Center', 'Awaken'); ?></option>
                            </select>
                        </div>
                    </div>
                </li>
        ...
        ?>>
            ...
            <ul class="form-elements">
                ...
                <li class="to-field">
                    ...
                    <label class="browse-icon"><input name="header_banner_image<?php echo cs_allow_special_char($rand_id) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'Awaken'); ?>"/></label>
                </li>
            </ul>
                    ...
                    <div class="input-sec">
                        <div class="select-style">
                            <select name="cs_home_v2_video_mute" class="dropdown">
                                ...
                                ?>><?php _e('Yes', 'Awaken'); ?> </option>
                                <option value="No" <?php
                                if ($cs_home_v2_video_mute == "No") {
                                    echo 'selected';
                                }
                                ?>> <?php _e('No', 'Awaken'); ?></option>
                            </select>
                        </div>
                    </div>
                </li>
                ...
                <li class="to-field">
                    <div class="input-sec">
                        ...
                        <label class="cs-browse">
                            <input id="cs_custom_bg_image" name="cs_custom_bg_image" type="button" class="uploadfile left" value="<?php _e('Browse', 'Awaken'); ?>" />
                        </label>
...
if (!function_exists('cs_seo_settitngs_element')) {
    ...
    function cs_seo_settitngs_element() {
        ...
        <ul class="form-elements ">
            <li class="to-label">
                <label><?php _e('Seo Title', 'Awaken'); ?> </label>
            </li>
            <li class="to-field">
                <div class="input-sec">
            ...
            <ul class="form-elements noborder">
                ...
                <li class="to-field">
                    <div class="input-sec">
                        ...
                        <label class="cs-browse">
                            <input id="cs_headerbg_image" name="cs_headerbg_image" type="button" class="uploadfile left" value="<?php _e('Browse', 'Awaken'); ?>" />
                        </label>
                ...
                <div class="input-sec">
                    <div class="select-style">
                        <select name="cs_background_skin">
                            ...
                            ?>><?php _e('Light', 'Awaken'); ?></option>
                            <option value="dark" <?php
                            if ($cs_background_skin == 'dark') {
                                echo 'selected="selected"';
                            }
                            ?>><?php _e('Dark', 'Awaken'); ?></option>
                        </select>
                    </div>
                </div>
            </li>
