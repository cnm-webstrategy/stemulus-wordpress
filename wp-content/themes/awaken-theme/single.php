                ...
                while (have_posts()) : the_post();
                    ...
                    if ($post_xml <> "") {
                        ...
                        if (isset($cs_layout) && $cs_layout == "sidebar_left") {
                            $cs_layout = "page-content blog-editor";
                            $cs_sidebar_left = $cs_theme_options['cs_default_layout_sidebar'];
                            $custom_height = 408;
                            $leftSidebarFlag = true;
                        } else if (isset($cs_layout) && $cs_layout == "sidebar_right") {
                            $cs_layout = "page-content blog-editor";
                            $cs_sidebar_right = $cs_theme_options['cs_default_layout_sidebar'];
                            $custom_height = 408;
                            $rightSidebarFlag = true;
                        } else {
                            $cs_layout = "col-md-12";
                    ...
                    <div class="<?php echo esc_attr($cs_layout); ?>"> 
                        ...
                        if (isset($cs_xmlObject->post_author_info_show) && $cs_xmlObject->post_author_info_show == 'on') {
                            if (empty($cs_xmlObject->post_author_info_text)) {
                                $post_author_info_text = __('Author', 'Awaken');
                            } else {
                                $post_author_info_text = $cs_xmlObject->post_author_info_text;
                            }
                            ?>
                            <div class="col-md-12">
                                <div class="cs-title"><a href="#"><i class="fa fa-tags"></i><?php echo $post_author_info_text; ?></a></div>
                        ...
                        if ($cs_related_post == 'on') {
                            if (empty($cs_xmlObject->cs_related_post_title))
                                $cs_related_post_title = __('Related Posts', 'Awaken');
                            else
