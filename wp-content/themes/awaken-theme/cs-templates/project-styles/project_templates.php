                ...
                while ($query->have_posts()) : $query->the_post();
                    ...
                    <div class="col-md-3">
                        ...
                        <article class="cs-projects projects-small<?php echo cs_allow_special_char($cs_noimage); ?>">
                            ...
                            <section>
                                <h2><a href="<?php the_permalink(); ?>"><?php echo substr(get_the_title(), 0, 24);
                    if (strlen(get_the_title()) > 24) echo '...'; ?></a></h2>
                                <ul class="post-option">
                                    <li><time datetime="<?php echo date_i18n('Y-m-d', strtotime(get_the_time())); ?>"><i class="fa fa-clock-o"></i><?php echo date_i18n(get_option('date_format'), strtotime(get_the_time())); ?></time></li>
